...
> **For OpenCode:** After writing this spec, use Phase 2 instructions found in `~/.config/opencode/skills/ds-plan/SKILL.md`.
...
### Project File Path Recommendation
For every new project, you should have a `docs/` folder in the root. 
